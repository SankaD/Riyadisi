/*
 * @(#)emlrt.h    generated by: makeheader 5.1.5  Thu Jan 17 15:19:00 2008
 *
 ...
 */
EXTERN_C void 
emlrtCheckVSBuiltIn(char *msgName, const mxArray *pa, 
                    char *className, boolean_T complex,
                    uint32_T nDims, void *pDims, void *vSize, 
                    void * /*aOut_data*/, int32_T *aOut_sizes, uint32_T * /*aOut_allocated*/);
 ...
 */
EXTERN_C void 
emlrtCheckFI(char *msgName, const mxArray *aFi, boolean_T aComplex, uint32_T nDims, void *vDims, const mxArray *fimath, const mxArray *numericType);
 ...
 */
EXTERN_C void
emlrtCheckVSStruct(char *msgName, const mxArray *s, int32_T nFields, const char **fldNames,
                   uint32_T nDims, void *pDims, void *vSize, 
                   void * /*aOut_data*/, int32_T *aOut_sizes, uint32_T * /*aOut_allocated*/);


/*
 * MATLAB INTERNAL USE ONLY :: Import a variable-sized array from an mxArray
 */
EXTERN_C void
emlrtGetVSArray(const mxArray *aIn, void *aOut_data, int32_T *aOut_sizes, uint32_T * /*aOut_allocated*/);
