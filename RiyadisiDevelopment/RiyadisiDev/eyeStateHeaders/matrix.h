/*
 * @(#)matrix.h    generated by: makeheader 5.1.5  Thu Jan 17 14:38:14 2008
 *
...
/* The following definition is required for Unicode support in MATLAB */
...
/*
 * mxGetProperty returns the value of an MCOS property for a given
 * object and index.
 *
 * If the given property name doesn't exist an error may be thrown.
 */
EXTERN_C mxArray *mxGetProperty(const mxArray *pa, mwIndex i, const char *propname);

 
/*
 * mxSetProperty sets the value of an MCOS property for a given object
 * and index.
 *
 * If the given property name doesn't exist an error may be thrown.
 */
 ...
 */
EXTERN_C void mxSetLogical(mxArray *pa);
 ...
 */
EXTERN_C void mxClearLogical(mxArray *pa);
