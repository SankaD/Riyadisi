...
public:
    ...
    static mwArray NewSparse(mwSize data_size, const mwIndex* rowindex,
			     const mwIndex* colindex, mxDouble* rData,
			     mxDouble *iData, mwSize num_rows, mwSize num_cols,
			     mwIndex nzmax, mxClassID id, mxComplexity cplx)
    {
        array_ref* p = 0;
